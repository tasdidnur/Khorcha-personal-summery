...
<div class="row">
    <div class="col-12">
      <form class="form-horizontal" method="post" action="{{url('dashboard/income/submit')}}" enctype="multipart/form-data">
            @csrf
        <div class="card">
            <div class="card-header">
              <div class="row">
                ...
                <div class="col-md-4 card_button_part">
                  <a class="btn btn-sm btn-dark" href="{{url('dashboard/income')}}"><i class="mdi mdi-reorder-horizontal me-1"></i><span>All Income</span></a>
                </div>
              </div>
            </div>
            <div class="card-body">
              ...
              <div class="row mb-3 {{ $errors->has('category') ? ' has-error' : ''}}">
                ...
                <div class="col-7">
                  @php
                    $allCategory=App\Models\IncomeCategory::where('incate_status',1)->orderBy('incate_id','ASC')->get();
                  @endphp
